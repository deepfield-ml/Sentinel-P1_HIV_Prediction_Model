...
[![License: GNU-2.0](https://img.shields.io/badge/License-GNU2.0-yellow.svg)](https://opensource.org/licenses/MIT)
...
*   `app.py`:  The main Python script containing the Tkinter-based GUI application for evaluating the ONNX model.
